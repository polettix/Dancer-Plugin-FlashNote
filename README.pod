...
Want to know more? L<See the module's documentation|http://search.cpan.org/perldoc?Dancer::Plugin::FlashNote> to figure out all
the bells and whistles of this module!

Want to install the latest release? L<Go fetch it on CPAN|http://search.cpan.org/dist/Dancer-Plugin-FlashNote/>.

Want to contribute? L<Fork it on GitHub|https://github.com/polettix/Dancer-Plugin-FlashNote>.
